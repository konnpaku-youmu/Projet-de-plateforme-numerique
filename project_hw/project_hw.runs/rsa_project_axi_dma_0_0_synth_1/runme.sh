...
HD_PWD='/home/yz/Projects/Digital_Platform_Design/design_package/hw_project/project_hw/project_hw.runs/rsa_project_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rsa_project_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rsa_project_axi_dma_0_0.tcl
