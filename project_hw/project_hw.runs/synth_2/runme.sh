...
HD_PWD='/home/yz/Projects/Digital_Platform_Design/design_package/hw_project/project_hw/project_hw.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log hweval_montgomery.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hweval_montgomery.tcl
